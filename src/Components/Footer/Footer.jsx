    ...
    <div className="footer">
      <div className="footer-logo">
        <Link className="nav-logo-link" to="/" onClick={handleLogoClick}>
          <img src={footer_logo} alt="PatronShop Logo" />
          <p className={`footer_${theme}`}>PatronShop</p>
        </Link>
      </div>
      ...
      <div className={`footer-copyright_${theme}`}>
        ...
        <p>Copyright @ PatronShop {new Date().getFullYear()} - Todos los derechos reservados</p>
      </div>
    </div>
  );
};
